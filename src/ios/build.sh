...
build_plugin_structure "$OUTPUT_DIR/iphone" iphoneos  " -extract armv7 -extract  arm64 "

build_plugin_structure "$OUTPUT_DIR/iphone-sim" iphonesimulator  " -extract i386  -extract  x86_64 "
